...
async function main() {
  ...
  if (balance === 0n) {
    throw new Error("Deployer has zero BNB balance. Fund the wallet before mainnet deployment.");
  }
  ...
  console.log("2. Verify: npm run verify:mainnet");
  console.log("3. Add PancakeSwap liquidity");
  console.log("4. Lock LP tokens");
  console.log("5. Renounce ownership when ready: token.renounceOwnership()");
}
