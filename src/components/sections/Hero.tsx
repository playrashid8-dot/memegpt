  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <GridBackground animated perspective />
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center pt-24 sm:pt-28 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 xl:gap-20 items-center">
            <div className="text-center lg:text-left order-2 lg:order-1">
              <motion.div
                ...
                className="inline-flex items-center gap-2 mb-6 sm:mb-8 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full glass-card-ultra text-[10px] sm:text-xs font-mono text-neon/85 border-neon/20"
              >
              ...
              <motion.p
                ...
                className="font-display text-lg sm:text-xl md:text-2xl lg:text-3xl text-neon/85 font-semibold mb-3 sm:mb-4 tracking-tight leading-snug"
              >
                {SITE.tagline}
              </motion.p>
              ...
              <motion.p
                ...
                className="text-sm sm:text-base md:text-lg text-foreground/50 max-w-xl mx-auto lg:mx-0 mb-10 sm:mb-12 leading-relaxed"
              >
                {SITE.heroSubtitle}
              </motion.p>
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 sm:gap-4 mb-12 sm:mb-14"
              >
                <Button href={SITE.links.buy} external className="w-full sm:w-auto min-w-[200px] btn-pulse-ring">
                  <span>🚀</span> Buy Token
                </Button>
              ...
              >
                {HERO_STATS.map((stat, i) => (
                  <motion.div
                    ...
                    className="glass-card-ultra rounded-xl p-3.5 sm:p-4 md:p-5 text-center corner-accent holographic-border"
                  >
            ...
            >
              ...
              <motion.div
                ...
                className="mt-8 sm:mt-10 w-full max-w-sm relative"
              >
                <div className="absolute inset-0 rounded-full bg-neon/6 blur-2xl pointer-events-none" />
                <AIOrb />
              </motion.div>
