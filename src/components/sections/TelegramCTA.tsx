    ...
    <section className="relative py-20 sm:py-28 md:py-32 overflow-hidden section-glow">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative glass-card-ultra rounded-2xl p-6 sm:p-10 md:p-16 lg:p-20 text-center border-neon/22 corner-accent holographic-border">
            <motion.div
            ...
            <h2 className="font-display text-[clamp(1.75rem,5vw,4rem)] font-black mb-4 sm:mb-5 gradient-text-shimmer leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-8 sm:mb-10">
              <Button href={SITE.links.telegram} external className="w-full sm:w-auto min-w-[220px] btn-pulse-ring">
                Join Telegram
              </Button>
