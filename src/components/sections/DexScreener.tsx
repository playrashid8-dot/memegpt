    ...
    <SectionWrapper id="chart" className="overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="relative rounded-2xl overflow-hidden glass-card-ultra border-neon/20 holographic-border"
        >
          ...
          <div className="relative aspect-[16/10] sm:aspect-[16/9] md:aspect-[21/9] min-h-[240px] sm:min-h-[320px] flex flex-col items-center justify-center p-6 sm:p-10 md:p-14">
            ...
            <div className="relative z-10 text-center max-w-md mx-auto">
              ...
              <h3 className="font-display text-xl sm:text-2xl md:text-3xl font-bold gradient-text-shimmer mb-3">
              ...
              <Button href={TOKEN.pancakeswapUrl} external className="min-w-[200px] btn-pulse-ring">
